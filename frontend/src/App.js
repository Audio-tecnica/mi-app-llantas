  ...
  return (
    <div className="max-w-7xl mx-auto p-4">
          ...
          {/* 🔍 Filtros arriba */}
            <div className="bg-white p-4 rounded shadow-md border mb-6">
             ...
             <input
               ...
               className="flex-1 p-2 border rounded shadow-sm focus:ring-2 focus:ring-green-400 outline-none"/>

              <select value={marcaSeleccionada} onChange={e => setMarcaSeleccionada(e.target.value)} className="flex-1 p-2 border rounded">
              <option value="">Todas las marcas</option>{marcasUnicas.map(m => (
     ...
     <button
      ...
      className="bg-gray-200 hover:bg-gray-300 text-sm text-black py-2 px-4 rounded">
      Limpiar filtros
    </button>
  </div>
</div>
